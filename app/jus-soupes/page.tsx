                            ...
                            <div key={comp.id} className="group glassmorphism bg-zinc-900/40 rounded-[48px] overflow-hidden border border-white/5 hover:border-orange-500/50 transition-all">
                                <div className="relative h-72 overflow-hidden">
                                    {comp.imageUrl ? (
                                        ...
                                        <div className="w-full h-full bg-zinc-800 flex items-center justify-center text-3xl font-black text-zinc-900 italic">ÉNERGIE</div>
                                    )}
                                ...
                                <div className="p-8">
                                    ...
                                    <p className="text-zinc-500 mb-6 line-clamp-2">
                                        {comp.description || "Un cocktail de vitalité préparé avec amour."}
                                    </p>
